...
// When served by the Node server, window.location.origin works perfectly.
// If somehow opened as a file:// URL, fall back to localhost:3000.
...
socket.on('connect_error', () => {
  document.getElementById('status').textContent = `Cannot reach server at ${SERVER_URL} — is it running?`;
  document.getElementById('status').style.color = '#ff4444';
});
