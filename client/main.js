...
const SPRITE_COLORS = {
  K: '#0a0a0a',  // outline
  S: '#d4a574',  // skin light
  s: '#c49060',  // skin dark / shadow
  H: '#ffcc44',  // player gold hair
  h: '#cc9922',  // hair shadow
  B: '#4455cc',  // shirt blue
  b: '#2233aa',  // shirt shadow
  T: '#ccdde8',  // pants light
  t: '#aabbcc',  // pants shadow
  G: '#224d12',  // NPC shirt / canopy mid
  g: '#183010',  // canopy dark
  E: '#44ff88',  // leaf highlight / accent
  R: '#a85c28',  // wood / trunk
  ...
  P: '#ce93d8',  // NPC purple shirt
  p: '#8844aa',  // NPC purple shadow
  C: '#00e5ff',  // pix robot accent
  c: '#90a4ae',  // pix robot body
  _: null,       // transparent
};
...
// ── REAL SPRITE DATA — extracted from uploaded asset pack ──
// 32×32 PNG frames, base64-encoded, loaded into canvas textures
// to maintain full compatibility with existing texture key system.
const REAL_SPRITES = {
  'player_down': 'data:image/png;base64,',
  'player_down_b': 'data:image/png;base64,',
  'player_up': 'data:image/png;base64,',
  'player_up_b': 'data:image/png;base64,',
  'player_right': 'data:image/png;base64,',
  'player_right_b': 'data:image/png;base64,',
  'player_left': 'data:image/png;base64,',
  'player_left_b': 'data:image/png;base64,',
  'npc_base': 'data:image/png;base64,',
  'npc_walk_a': 'data:image/png;base64,',
  'npc_walk_b': 'data:image/png;base64,',
};

/**
 * Load a base64 PNG into an existing Phaser canvas texture.
 * @param {Phaser.Scene} scene
 * @param {string} key   — texture key (must already be registered or will create)
 * @param {string} dataUrl
 */
function loadSpriteIntoTexture(scene, key, dataUrl) {
...
/**
 * Replace all procedurally-drawn player/NPC textures with
 * the real pixel-art sprites from the uploaded asset pack.
 * Called once after createTextures() finishes.
 */
async function upgradeSpritesToRealArt(scene) {
  const keys = Object.keys(REAL_SPRITES);
  await Promise.all(keys.map(k => loadSpriteIntoTexture(scene, k, REAL_SPRITES[k])));
  console.log('[sprites] Real art loaded for:', keys.join(', '));
  
  // Refresh any already-spawned NPC sprites to use the new textures
  for (const [id, data] of Object.entries(gameState.npcSprites || {})) {
    const texKey = `npc_${id}`;
    if (scene.textures.exists(texKey)) {
      // Rebuild NPC texture with real art base tinted with NPC color
      if (scene.textures.exists('npc_base')) {
        if (scene.textures.exists(texKey)) scene.textures.remove(texKey);
        const src = scene.textures.get('npc_base');
        const t   = scene.textures.createCanvas(texKey, 32, 32);
        const ctx = t.getContext();
        ctx.imageSmoothingEnabled = false;
        ctx.drawImage(src.getSourceImage(), 0, 0);
        t.refresh();
        data.sprite?.setTexture(texKey);
      }
    }
  }

  // Refresh player sprite
  if (gameState.mySprite && scene.textures.exists('player_down')) {
    gameState.mySprite.setTexture('player_down');
  }
}
...
class GameScene extends Phaser.Scene {
  ...
  create() {
    ...
    // ── Upgrade procedural sprites to real pixel-art from asset pack ──
    // Runs async but completes in <100ms (base64 decode only, no network)
    upgradeSpritesToRealArt(this);
